...
class Agent:
    def __init__(self, epsilon=1.0, mbsz=32, discount=0.9, memory=50,
                 save_name='saivs_dqn', save_freq=10):
    ...
    def build_dqn(self, state_size=None, number_of_actions=1):
        self.state_size = state_size
        self.number_of_actions = number_of_actions
        self.build_functions()

    def build_model(self):
        print("Building MLP and Q-Learning...")
        S = Input(shape=self.state_size)
        h = Dense(100, activation='relu')(S)
        ...
        try:
            ...
            print("Training a new attack model")
